...
export const metadata: Metadata = {
    title: 'Agendas | DescabaGeek',
    description: 'Confere todos os nossos Agendas e Detonados.',
};
...
export default async function GuiasPage() {
    // Filtro na URL
    const res = await fetch(`${apiUrl}/api/posts?filters[categoria][$eq]=Agendas&populate=*`, {
        cache: 'no-store'
    });
