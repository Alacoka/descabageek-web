...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR">
      <body
        className={`${fontBase.className} bg-[#060111] text-gray-100 antialiased flex flex-col min-h-screen`}
      >
        ...
        <footer className="bg-[#030009] text-white pt-16 pb-8 border-t border-purple-950 shadow-[0_0_20px_rgba(168,85,247,0.1)]">
          <div className="max-w-[1400px] mx-auto px-4 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
              ...
              <div>
                <h3 className="font-bold uppercase tracking-wider mb-4 text-gray-200">
                  Saiba mais
                </h3>
                <ul className="space-y-3 text-sm text-gray-400 font-medium">
                  <li>
                    <Link
                      href="https://www.youtube.com/@DescabaGeek"
                      target="blank"
