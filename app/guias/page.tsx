...
export const metadata: Metadata = {
    title: 'Guias | DescabaGeek',
    description: 'Confere todos os nossos Guias e Detonados.',
};
...
export default async function GuiasPage() {
    // Filtro na URL
    // Pedimos ao Strapi apenas os posts onde o campo "categorias" seja exatamente igual a "Guias"
    const res = await fetch(`${apiUrl}/api/posts?filters[categoria][$eq]=Guias&populate=*`, {
        cache: 'no-store'
    });
